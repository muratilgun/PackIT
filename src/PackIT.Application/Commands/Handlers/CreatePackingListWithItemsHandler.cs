...
namespace PackIT.Application.Commands.Handlers
{
    public class CreatePackingListWithItemsHandler : ICommandHandler<CreatePackingListWithItems>
    {
        ...
        public CreatePackingListWithItemsHandler(IPackingListRepository repository, IPackingListFactory factory, IPackingListReadService readService, IWeatherApiService weatherService)
        {
        ...
        public async Task HandleAsync(CreatePackingListWithItems command)
        {
            ...
            var packingList = _factory.CreateWithDefaultItem(id, name, days, gender, weather.Temperature, localization);
